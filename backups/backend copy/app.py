...
# from llm_handler import LLMHandler                    # MODERATE: Current default, balanced modifications
from llm_handler_advanced import LLMHandler         # ADVANCED: Can add windows, roofs, walls, major changes
# from llm_handler_restricted import LLMHandler       # RESTRICTED: Only ±20% adjustments, rejects major changes
...
def get_current_design():
    ...
    try:
        ...
        params = modifier.current_params
...
def modify_design():
    ...
    try:
        ...
        interpretation = llm.interpret_modification(user_input, modifier.current_params)
        ...
        if not modifications:
            return jsonify({
                'status': 'no_changes',
                'message': 'No modifications identified',
                'understood': interpretation.get('understood')
            })
        ...
        return jsonify({
            ...
            'new_parameters': modifier.current_params,
            'analysis': analysis,
